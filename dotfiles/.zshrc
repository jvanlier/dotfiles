...
# Prompt is Starship (initialized near the bottom); let oh-my-zsh handle plugins only.
ZSH_THEME=""
...
# Starship prompt (renders only on Enter; no SIGWINCH redraw on window resize).
